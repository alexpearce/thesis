...
in each \ptotetanspd\ bin, one before and one after the \ac{PID} requirement, 
where the signal \PDzero decays can be modelled as a peaking structure and the 
combinatorial background can be modelled as a linear or exponential function.
...
symmetric uncertainties of zero, or $\pm1\sigma$ intervals that include 
unphysical efficiencies when \effest\ is small.

...
distribution for many tag-and-probe candidates can be used to distinguish 
between backgrounds and true \PJpsi decays.
...
in the 14--\SI{25}{\GeVc} region, such that a single bin would be a sufficient 
model.

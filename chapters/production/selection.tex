...
\begin{figure}
  ...
  \caption{%
    ...
    selection (\cref{fig:prod:sel:D0ToKpi:online}) and after the offline 
    selection (\cref{fig:prod:sel:D0ToKpi:offline}).
  }
...
\begin{figure}
  ...
  \caption{%
    ...
    selection (\cref{fig:prod:sel:DpToKpipi:online}) and after the offline 
    selection (\cref{fig:prod:sel:DpToKpipi:offline}).
  }
...
\begin{figure}
  ...
  \caption{%
    ...
    selection (\cref{fig:prod:sel:DsToKKpi:online}) and after the offline 
    selection (\cref{fig:prod:sel:DsToKKpi:offline}).
...
\begin{figure}
  ...
  \caption{%
    ...
    selection (\cref{fig:prod:sel:DstToD0pi_D0ToKpi:online}) and after the 
    offline selection (\cref{fig:prod:sel:DstToD0pi_D0ToKpi:offline}).
  }

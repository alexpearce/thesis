...
efforts made using the \acp{GPD}, due to the unique rapidity range the detector 
...
from proton-proton collisions can be expressed as
\begin{equation}
  \xsec(\PHc) = \frac{%
    N(\HcTof)
  }{%
...
\end{equation}
where the $i$ is the index of the \pTy\ bin.

The analysis presented in this \namecref{chap:prod} measures the double 

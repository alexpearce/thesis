...
productions measurements.\footnotemark
...
$\pT > \SI{1}{\GeV}$ at \sqrtseq{2.76}\ and \sqrtseq{7}\ by the \alice\ 
collaboration~\cite{Abelev:2012sx,ALICE:2012ik,ALICE:2011aa},
and for pseudorapidity $|\Eta| < 2.1$ in the \pT\ region $3.5 < \pT < 
\SI{100}{\GeV}$ at \sqrtseq{7} by the \atlas\ collaboration~\cite{Aad:2015zix}.
...
for \pT\ values of the order of \SI{1}{\GeV} at the lowest rapidities 
...
% TODO include a plot or two from the 7 TeV measurement, firstly to show what 
% the different predictions look like, and secondly to highlight the 
% disagreement with the theory, to motivate further measurements

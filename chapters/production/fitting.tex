...
\begin{align}
  f(m) &= \frac{1}{\sum_{\textnormal{Species}} N_{\textnormal{Species}}}
          \sum_{\textnormal{Species}} N_{\textnormal{Species}}
          f_{\textnormal{Species}}(m),\\
  f(\deltam) &= \frac{1}{\sum_{\textnormal{Species}} N_{\textnormal{Species}}}
                \sum_{\textnormal{Species}} N_{\textnormal{Species}}
...
weighted by the respective species' yields
\begin{equation}
  f(\lnipchisq) = \frac{1}{\sum_{\textnormal{Species}} N_{\textnormal{Species}}}
                  \sum_{\text{Species}} N_{\text{Species}}

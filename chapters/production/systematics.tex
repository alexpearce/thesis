...
cross-section measurement, are given in \cref{tab:prod:syst:mc:stat:D0ToKpi} 
for \DzToKpi.
...
This is given for each mode in \cref{tab:prod:syst:mc:modelling}.
...
\cref{tab:syst:signal_window:DzToKpi} relative to the cross-section values for 
\DzToKpi.

...
from the centre of the acceleraa.
...
The data produced are selected in real time by a hardware trigger, after which 
...
% TODO citation for aerogel removal? RICH performance paper maybe

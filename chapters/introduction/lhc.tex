...
This section shall describe the machine, the experiments which it services, and 
...
$\gamma$ is the Lorentz term, where $v/c \approx 1$; $\epsilon$ is the beam 
emittance during circulation, a measure of the beam size transverse to the beam 
direction; $\beta^{*}$ is a measure of the transverse beam size at a particular 
...
= \SI{1e-35}{\per\square\centi\metre}$, around 0.1 Higgs bosons are produced 
every second, from \cref{eqn:intro:lhc:lumi_xsec}.
...
analysis.
This balance of collecting as much data as possible and having the computing 
resources to analyse it is a problem common to all experiments, and will be 
explored further in \cref{chap:intro:lhcb:trigger}.

In addition to the nominal \pp\ running, the \ac{LHC} also runs with 
...
and lead-proton configurations.
...
forms in ion collisions.
The plasma is a hot, dense, and exotic state of matter that was dominant in the 
...
It does come with a price, however, as the rates of other physical processes 

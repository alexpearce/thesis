...
final state $f$ is given by the parameter \ACP\
\begin{equation}
...
As discussed in \cref{chap:cpv:introduction}, this analysis reconstructs the 
\PLambdac\ decays \pKK\ and \ppipi, originating from 
\decay{\PLambdab}{\PLambdac\Pmuon X}\ decays.

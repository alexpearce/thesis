...
This \lcnamecref{chap:cpv:prelim_fits} describes the binned \chisq\ fit to the 
...
\begin{table}
  ...
  \input{tables/cpv/preliminary_fits/LcTopKK_2012_MagDown_fit-parameters}
\end{table}
...
\begin{table}
  ...
  \input{tables/cpv/preliminary_fits/LcToppipi_2012_MagDown_fit-parameters}
\end{table}

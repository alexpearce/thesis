...
% TODO also presented the unweighted results. should mention that a) the 
% weighting doesn't change the central value by much (showing the distributions 
% already agreed well, assuming the weighting worked), and b) the statistical 
% precision doesn't change much. considering we throw away ~20–25% of the ppipi 
% data in the weighting, this shows that the stat. unc. is dominated by pKK

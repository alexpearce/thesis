...
In this \lcnamecref{chap:cpv:syst:fit}, this method will first be defined and 
...
\begin{table}
  ...
  \input{tables/cpv/systematics/kaon_detection_asymmetry}
\end{table}
...
\begin{table}
  ...
  \input{tables/cpv/systematics/muon_detection_asymmetry}
\end{table}

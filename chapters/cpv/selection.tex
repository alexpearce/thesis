...
To define a starting point for the cut values, a simultaneous optimisation of 
...
respectively.
\Cref{fig:selection:background_study:ppipi_meson,fig:selection:background_study:ppipi_baryon} 
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \label{fig:cpv:selection:background_study:ppipi_meson:pipik}
  \end{subfigure}
  \caption{%
    Wrong-mass distributions obtained when changing the mass hypotheses of the 
